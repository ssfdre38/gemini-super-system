...
<body>
  ...
  <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(360px, 1fr)); gap: 16px; margin-bottom: 20px;">
    ...
    <div class="control-deck" style="border-color: rgba(16, 185, 129, 0.4); margin-bottom: 0;">
      ...
      <div style="margin-top: 10px; background: rgba(0, 229, 255, 0.08); border: 1px solid rgba(0, 229, 255, 0.25); border-radius: 8px; padding: 10px 14px; display: flex; align-items: center; justify-content: space-between; gap: 12px;">
        <div style="display: flex; align-items: center; gap: 10px; overflow: hidden;">
          <span style="font-size: 16px;">💭</span>
          <div style="overflow: hidden;">
            <div style="font-size: 11px; text-transform: uppercase; color: var(--accent); letter-spacing: 0.5px; font-weight: bold;">Living Cognition Thought Stream:</div>
